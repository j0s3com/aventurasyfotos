...
/* Swiper */
   ...
   var swiper = new Swiper(".weatherinfo", {
     loop: true,
     speed:800,
     autoplay:{
       delay:3000
  ...
  breakpoints: {
    ...
    765: {
      ...
      var swiper = new Swiper(".swipertravelcategory", {
     loop: true,
     speed:800,
     autoplay:{
       delay:3000
  ...
  breakpoints: {
   ...
   var swiper = new Swiper(".swipersimilartours", {
     loop: true,
     speed:800,
     autoplay:{
       delay:3000
...
$(window).scroll(function() {
  var scroll = $(window).scrollTop();
	$(".scrollimg").css({
		transform: 'scale('+(150 + scroll/30)/150+')',
		//Blur
...
$(document).ready(function(){
	...
	$( ".wishlistbtn" ).each(function(index) {
		$(this).on("click", function(){
			$(this).toggleClass("btn-action-icon-active");
			$(this).find("i").toggleClass("btnlink-icon-active");
			
			if ($(this).hasClass("btn-action-icon-active")) {
			$(function() {
		...
		$(function() {
			...
			Toast.fire({
				icon: 'warning',
				title: ' Tour removed from Wishlist '
			})
	...
	$( ".comparebtn" ).each(function(index) {
		$(this).on("click", function(){
			$(this).toggleClass("btn-action-icon-active");
			$(this).find("i").toggleClass("btnlink-icon-active");
			...
			Toast.fire({
				icon: 'success',
				title: ' Tour added to Comparison list '
			})
		...
		$(function() {
			...
			Toast.fire({
				icon: 'warning',
				title: ' Tour removed from Comparison list '
			})
...
$(".color").click(function(){
    ...
    id: 1,
    title: "Barcelona",
    image: 'assets/img/tours/barcelona.jpg',
	price: 1180.00,
    ...
    id: 2,
    title: "New Zealand",
    image: 'assets/img/tours/newzealand.jpg',
	price: 1400.00,
  },
  {
    id: 3,
    title: "Indonesia",
    image: 'assets/img/tours/indonesia.jpg',
	price: 950.00,
  },
  {
    id: 4,
    title: "Japan",
    image: 'assets/img/tours/japan.jpg',
	price: 1350.00,
  },
  {
    id: 5,
    title: "Paris",
    image: 'assets/img/tours/paris.jpg',
	price: 830.00,
  },
  {
    id: 6,
    title: "Venice",
    image: 'assets/img/tours/venice.jpg',
	price: 1030.00,
  },
	...
	// add active class when tour in cart ;	
		
	$( ".addtocartbtn" ).each(function(index) {
		$(this).on("click", function(){
			$(this).addClass("btn-action-icon-active");
			$(this).find("i").addClass("btnlink-icon-active");
		});
	});	
		
	// add active class when single tour in cart ;
	
	$(".btnaddtocartactive").click(function(){
		$(".btnaddtocartactive").addClass("btn-addtocart-active");	
	});	
	
	// add active class in wishlist page when tour in cart ;
		
	$( ".btnaddtocartwishlistactive" ).each(function(index) {
		$(this).on("click", function(){
			$(this).addClass("btn-addtocart-wishlist-active");
		});
	});	
...
$("#submitOrder").on("submit",function(e){
  e.preventDefault();
	...
	var checkoutdeparture = $("input[name='departure']:checked").val(); 
  ...
  if(checkoutname == "") {
	...
	$.ajax({
	  ...
	  data :{checkoutname:checkoutname,
			 ...
			 checkoutdeparture:checkoutdeparture,
